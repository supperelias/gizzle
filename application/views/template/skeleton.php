...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(CSS . "plugins/themes/default/default.css"); ?>">
        <link rel="stylesheet" href="<?php echo base_url(CSS . "plugins/jquery.touchTouch.css"); ?>">
...
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,600,700,300' rel='stylesheet' type='text/css'>
    ...
    <body>
        ...
        <script src="<?php echo base_url(JS . "plugins/jquery.scrollTo-1.4.3.1-min.js"); ?>"></script>
        <script src="<?php echo base_url(JS . "plugins/jquery.touchTouch.min.js"); ?>"></script>
